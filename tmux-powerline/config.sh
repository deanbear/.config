...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/q2/x_klqqts5_1c_fcpkfzq_bn40000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/bear/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/bear/.mailcheckrc"
# }
...
# weather.sh {
	...
	export TMUX_POWERLINE_SEG_WEATHER_UPDATE_PERIOD="300"
	...
	TMUX_POWERLINE_SEG_WEATHER_LAT="30.2666"
	TMUX_POWERLINE_SEG_WEATHER_LON="120.0419"
	TMUX_POWERLINE_SEG_WEATHER_ICON_SET="nerd-font"
# }
